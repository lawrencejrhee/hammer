...
// DO NOT EDIT. Regenerate via `hammer-pd-store design-register`.
...
def emit_common_yml(
    ...
    lines: List[str] = []
    lines.append(f"# AUTO-GENERATED by hammer-pd-store design-register for '{design}'.")
...
def emit_syn_yml(design: str, clock_ns: float) -> str:
    ...
    fifth = clock_ns / 5.0
    return f"""# AUTO-GENERATED by hammer-pd-store design-register for '{design}'.
...
def _emit_sky130_extras_yml(srams: List[Sram22Info]) -> str:
    lines: List[str] = []
    lines.append("# AUTO-GENERATED by hammer-pd-store augment.")
